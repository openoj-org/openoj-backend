...
router.post(
  ...
  upload.single("data"),
  service.problem_change_by_file
);
...
router.post(
  ...
  upload.single("data"),
  service.problem_create_by_file
);

// 创建题目
router.post("/problem/create", upload.single("data"), service.problem_create);
