...
router.post(
  ...
  upload.single("data"),
  service.workshop_change_by_file
);
...
router.post(
  ...
  upload.single("data"),
  service.workshop_create_by_file
);

// 创建题目
router.post("/workshop/create", upload.single("data"), service.workshop_create);
